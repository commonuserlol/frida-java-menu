namespace Menu {
    export class Dialog extends Object {
        ...
        public setPositiveButton(callback: (this: Dialog) => void) {
            this.instance.setPositiveButton(wrap(Menu.instance.theme.dialogPositiveText), Java.registerClass({
        ...
        public setNegativeButton(callback: (this: Dialog) => void) {
            this.instance.setNegativeButton(wrap(Menu.instance.theme.dialogNegativeText), Java.registerClass({
                name: randomString(35),
                implements: [Api.DialogInterfaceOnClickListener],
                methods: {
                    getName: function() {
